...
netParams.addPopParams('background_E', {'cellModel': 'NetStim', 'rate': 20, 'noise': 1})  # background inputs to Exc
netParams.addPopParams('background_I', {'cellModel': 'NetStim', 'rate': 20, 'noise': 1})  # background inputs to Inh
