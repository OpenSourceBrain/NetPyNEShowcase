...
netParams.stimSourceParams['background_E']  = {'type': 'NetStim', 'rate': 20, 'noise': 1} # background inputs to Exc
netParams.stimSourceParams['background_I']  = {'type': 'NetStim', 'rate': 20, 'noise': 1} # background inputs to Inh
