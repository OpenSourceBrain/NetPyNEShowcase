...
PARAMETER {
    ...
    m_forwardRate_scale = 13.89 (mV)       : was: 0.01389 (voltage)
    ...
    h_timeCourse_TIME_SCALE = 1000 (ms)    : was: 1.0 (time)
    h_timeCourse_VOLT_SCALE = 1000 (mV)    : was: 1.0 (voltage)
    h_steadyState_TIME_SCALE = 1000 (ms)   : was: 1.0 (time)
    h_steadyState_VOLT_SCALE = 1000 (mV)   : was: 1.0 (voltage)
}
