...
# For saving to file: Sim_SimpleNet.RS_pop.v.dat (ref: Volts_file__RS_pop)
# Column: v_RS_pop_0_RS_v: Pop: RS_pop; cell: 0; segment id: $oc.segment_id; segment name: soma; Neuron loc: soma(0.5); value: v (v)
simConfig.recordTraces['Volts_file__RS_pop_RS_pop_0_soma_v'] = {'sec':'soma','loc':0.5,'var':'v','conds':{'pop':'RS_pop','cellLabel':0}}
# Column: v_RS_pop_1_RS_v: Pop: RS_pop; cell: 1; segment id: $oc.segment_id; segment name: soma; Neuron loc: soma(0.5); value: v (v)
simConfig.recordTraces['Volts_file__RS_pop_RS_pop_1_soma_v'] = {'sec':'soma','loc':0.5,'var':'v','conds':{'pop':'RS_pop','cellLabel':1}}
# Column: v_RS_pop_2_RS_v: Pop: RS_pop; cell: 2; segment id: $oc.segment_id; segment name: soma; Neuron loc: soma(0.5); value: v (v)
...
if sim.rank==0: 
    print("Saving to file: Sim_SimpleNet.RS_pop.v.dat (ref: Volts_file__RS_pop)")

 
    # Column: t
    col_Volts_file__RS_pop_t = [i*simConfig.dt for i in range(int(simConfig.duration/simConfig.dt))]

    # Column: v_RS_pop_0_RS_v: Pop: RS_pop; cell: 0; segment id: $oc.segment_id; segment name: soma; value: v
    col_Volts_file__RS_pop_v_RS_pop_0_RS_v = sim.allSimData['Volts_file__RS_pop_RS_pop_0_soma_v']['cell_%s'%gids['RS_pop'][0]]

    # Column: v_RS_pop_1_RS_v: Pop: RS_pop; cell: 1; segment id: $oc.segment_id; segment name: soma; value: v
    col_Volts_file__RS_pop_v_RS_pop_1_RS_v = sim.allSimData['Volts_file__RS_pop_RS_pop_1_soma_v']['cell_%s'%gids['RS_pop'][1]]

    # Column: v_RS_pop_2_RS_v: Pop: RS_pop; cell: 2; segment id: $oc.segment_id; segment name: soma; value: v
    col_Volts_file__RS_pop_v_RS_pop_2_RS_v = sim.allSimData['Volts_file__RS_pop_RS_pop_2_soma_v']['cell_%s'%gids['RS_pop'][2]]

    dat_file_Volts_file__RS_pop = open('Sim_SimpleNet.RS_pop.v.dat', 'w')
    for i in range(len(col_Volts_file__RS_pop_t)):
        dat_file_Volts_file__RS_pop.write( '%s\t'%(col_Volts_file__RS_pop_t[i]/1000.0) +  '%s\t'%(col_Volts_file__RS_pop_v_RS_pop_0_RS_v[i]/1000.0) +  '%s\t'%(col_Volts_file__RS_pop_v_RS_pop_1_RS_v[i]/1000.0) +  '%s\t'%(col_Volts_file__RS_pop_v_RS_pop_2_RS_v[i]/1000.0) +  '\n')
    dat_file_Volts_file__RS_pop.close()
